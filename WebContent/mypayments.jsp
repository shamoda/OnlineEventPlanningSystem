...
<html>
<head>
<title>Eventura - My Payments</title>
<link rel="stylesheet" type="text/css" href="styles/mypayments.css">
<link rel="stylesheet"
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<%
										...
										ResultSet rs = stmt.executeQuery("select * from payments where uId = " + uId1 + " ");
									...
									<tr>
										<td class="event-title"><%=rs.getString("pId")%><br>
										<br></td>
										<td><%=rs.getString("date")%></td>
										<td class="ticketNo"><%=rs.getString("cost")%> LKR <br>
										<a href="deletepayment?pId=<%=rs.getString("pId")%>"
