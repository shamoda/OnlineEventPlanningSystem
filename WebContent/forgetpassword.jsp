...
<html>
<head>
<title>Eventura - Forgot Password</title>
...
<body>
	...
	<section id="register">
		<form class="box" action="forgetpassword" method="get">
			<h1>Forgot Credentials ?</h1>
			<br> <input type="text" name="mobile"
				placeholder="Enter Your Mobile Number" required> <input
			...
			<p>
				...
				if (null != request.getAttribute("failed")) {
					out.println(request.getAttribute("failed"));
				}
				%>
			</p>

			<input type="submit" name="submit" value="Show My Credentials">
		</form>
