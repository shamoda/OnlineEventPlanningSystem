...
<html>
<head>
<title>Eventura - Newsletter Subscriptions</title>
					...
					<div class="recent-events">
						...
						<div class="event-table">
							<table class="table table-hover">
								<thead>
									<tr>
										<th class="col1">Subscription ID</th>
								...
								<tbody>
									...
									<%
										...
										//retrieving newsletters
										Connection connection = connectionUtil.getConnection();
										Statement stmt = connection.createStatement();
										ResultSet rs = stmt.executeQuery("select * from newsletter ORDER BY nId DESC ");
										/*if( rs.next() == false){
									...
									<tr>
										<td class="event-title"><%=rs.getString("nId")%></td>
