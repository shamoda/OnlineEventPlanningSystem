	...
	<section id="register">
		<form class="box" action="register" method="post">
			...
			<input type="text" name="name" placeholder="Name" required> <input
				type="number" name="uId" placeholder="User ID" max="9999" required> <input
				type="text" name="mobile" placeholder="Mobile" required> <input
				type="email" name="email" placeholder="E-mail" required> <input
