...
<html>
<head>
<title>Eventura - Change Password</title>
...
<body>
	...
	<div class="notify">
		<p>
			<%
				if (null != request.getAttribute("changed")) {
				out.println(request.getAttribute("changed"));
			}
	...
	<section id="register">
		<form class="box" action="changepassword" method="get">
			<h1>Change Password</h1>
			<br> <input type="hidden" name="uId" value="<%=uId1%>" required>
			<input type="password" name="cpwd"
				placeholder="Enter Your Current Password" required> <input
				type="password" name="npwd" placeholder="Enter Your New Password"
