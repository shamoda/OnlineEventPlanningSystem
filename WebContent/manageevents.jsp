...
<html>
<head>
<title>Eventura - Manage Events</title>
<link rel="stylesheet" type="text/css" href="styles/manageevents.css">
<link rel="stylesheet"
								...
								<tbody>
									<%
										try {
											...
											//getting all events to a result set
											//printing them on a table
										Connection connection = connectionUtil.getConnection();
										Statement stmt = connection.createStatement();
										ResultSet rs = stmt.executeQuery("select * from event ORDER BY eId DESC");
										while (rs.next()) {
									%>
									<tr>
										...
										<td class=""><a
											href="deleteevent?eventId=<%=rs.getString("eId")%>"
