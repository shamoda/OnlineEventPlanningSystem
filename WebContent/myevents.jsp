...
<html>
<head>
<title>Eventura - My Events</title>
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<%
										...
										//retrieving all the events of logged user
										Connection connection = connectionUtil.getConnection();
										Statement stmt = connection.createStatement();
										ResultSet rs = stmt.executeQuery("select * from event where uId = '" + uId1 + "' ORDER BY eId DESC");
										/*if( rs.next() == false){
									...
									<tr>
										<td class="event-title"><%=rs.getString("title")%> <br>
											<br> <a
											href="updateevent.jsp?eId=<%=rs.getString("eId")%>"
