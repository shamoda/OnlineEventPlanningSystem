...
<html>
<head>
<title>Eventura - Update profile</title>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<%
						...
						ResultSet rs = stmt.executeQuery("select * from user where uId = '" + uId1 + "' ");
						rs.next();
					%>
					...
					<div class="create-event">
						...
						<form class="box" action="updateprofile" method="get">
							<input type="hidden" name="cuId" value="<%=rs.getString("uId")%>"
								required> <input type="text" name="nuId"
								value="<%=rs.getString("uId")%>" readonly> <input
								type="text" name="name" value="<%=rs.getString("name")%>"
								required> <input type="text" name="mobile"
								value="<%=rs.getString("mobile")%>" required> <input
								type="email" name="email" value="<%=rs.getString("email")%>"
								required> <input type="submit" name="registeradmin"
								value="Complete">
						</form>
