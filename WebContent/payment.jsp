						...
						<div class="create-event">
							...
							<form action="payment">
								<div class="row">
									...
									<div class="input1 col-md-4">Card Number :</div>
								...
								<div class="row">
									<div class="input1 col-md-4">CCV :</div>
									<div class="input2 col-md-8">
										<input type="text" name="ccv"
											placeholder="Enter card ccv here" required> <br>
										<br>
									</div>
								</div>
								...
								<div class="row">
									<div class="input1 col-md-4">Card type :</div>
									<div class="input2 col-md-8">
